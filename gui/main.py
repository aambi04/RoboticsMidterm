...
positionLabelx = Label(leftFrame, width=5, anchor=W)
...
positionLabely = Label(leftFrame, width=5, anchor=W)
...
wheel1Label = Label(leftFrame, width=5, anchor=W)
...
wheel2Label = Label(leftFrame,  width=5, anchor=W)
...
wheel3Label = Label(leftFrame,  width=5, anchor=W)
...
wheel4Label = Label(leftFrame, width=5, anchor=W)
...
velocity_xLabel = Label(leftFrame,  width=5, anchor=W)
...
velocity_yLabel = Label(leftFrame, width=5, anchor=W)
